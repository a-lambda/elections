...
if (!file.exists("data/legislatives_2024/tour_1/resultats_ori_1.RDS")) {
  resultats_1 <- read_xlsx("data/legislatives_2024/tour_1/resultats-definitifs-par-communes.xlsx")
  saveRDS(resultats, "data/legislatives_2024/tour_1/resultats_ori_1.RDS")
} else {
  resultats_1 <- readRDS("data/legislatives_2024/tour_1/resultats_ori_1.RDS")
}
str(resultats_1, strict.width = "wrap", list.len = 26)

if (!file.exists("data/legislatives_2024/tour_2/resultats_ori_2.RDS")) {
  resultats_2 <- read_xlsx("data/legislatives_2024/tour_2/resultats-definitifs-par-commune.xlsx")
  saveRDS(resultats, "data/legislatives_2024/tour_2/resultats_ori_2.RDS")
} else {
  resultats_2 <- readRDS("data/legislatives_2024/tour_2/resultats_ori_2.RDS")
}
str(resultats_2, strict.width = "wrap", list.len = 26)
